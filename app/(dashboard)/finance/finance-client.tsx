...
import { TuitionStats } from "./tuition-stats"
    ...
    <div className="flex flex-col gap-4">
      ...
      <Tabs defaultValue="overview" className="w-full">
        <TabsList className="grid w-[400px] grid-cols-2">
          ...
          <TabsTrigger value="tuition">Thống kê Học phí</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="overview" className="space-y-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Danh sách giao dịch trong tháng {selectedMonth.split('-').reverse().join('/')}.
              </CardDescription>
            </CardHeader>
            <CardContent>
              {loading ? (
                ...
                <Table>
                    ...
                    {transactions.length === 0 ? (
                        <TableRow>
                            <TableCell colSpan={6} className="text-center text-muted-foreground">Chưa có giao dịch nào trong tháng này</TableCell>
                        </TableRow>
                    ) : (
